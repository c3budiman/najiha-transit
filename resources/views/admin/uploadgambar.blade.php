...
thead{
  ...
  <div class="card">
    <div class="card-header">
      <h3 class="card-title">Tabel Upload File Gambar</h3>
      <br>
       <button class="btn btn-primary btn-lg" data-toggle="modal" data-target="#modaluploadgambar"><i class="fa fa-plus"></i> Unggah Berkas Gambar</button>
            ...
            @foreach ($filegambar as $value)
              <tr>
                ...
                <td>
                  ...
                  <a class="btn btn-danger" onclick="return confirm('Yakin ingin menghapus gambar {{ $value->nama_file }}?')" href="/delete/gambar/{{ $value->id }}"><i class="fa fa-trash"></i></a>
                </td>
              </tr>
            @endforeach
          </tbody>
      ...
      <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <h3 class="text-center" style="padding-bottom: 10px;"> Tambah Berkas Gambar Moda Transportasi</h3>
              ...
              <form action="{{ route('gambar.upload') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group {{ !$errors->has('nama_file') ?: 'has-error' }}">
                  <label>Nama Berkas</label>
                    <input type="text" name="nama_file" class="form-control" placeholder="Gambar_JenisModa.[jpg/jpeg/png]" maxlength="50">
